...
namespace Eshava.Core.Linq.Interfaces
{
	public interface IWhereQueryEngine
	{
		...
		/// <returns></returns>
		IEnumerable<Expression<Func<T, bool>>> BuildQueryExpressions<T>(object filter, string globalSearchTerm, Dictionary<string, List<Expression<Func<T, object>>>> mappings = null) where T : class;
		...
		/// <returns></returns>
		IEnumerable<Expression<Func<T, bool>>> BuildQueryExpressions<T>(IEnumerable<WhereQueryProperty> whereQueryProperties, string globalSearchTerm, Dictionary<string, List<Expression<Func<T, object>>>> mappings = null) where T : class;
